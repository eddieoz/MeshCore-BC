...
bool DMDecapsulator::decapsulateDM(const EncapsulatedPacket& packet,
                                    uint64_t senderId,
...
void DMDecapsulator::decryptPayload(const uint8_t* input, size_t len,
                                     const uint8_t* key,
...
bool DMDecapsulator::deserializeMessage(const uint8_t* data, size_t len,
