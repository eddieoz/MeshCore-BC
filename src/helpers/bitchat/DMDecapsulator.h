...
struct DMDecapsulationResult {
  ...
  DMDecapsulationResult()
      : status(DMDecapsulationStatus::NOT_BITCHAT), senderId(0), isKnownContact(false), timestamp(0) {
...
public:
   ...
   */
  bool decapsulateDM(const EncapsulatedPacket &packet, uint64_t senderId, const uint8_t *recipientKey,
