...
const uint64_t EXPECTED_PEER_ID = 0x0807060504030201ULL;
...
void test_peer_id_to_bytes(void) {
    ...
    TEST_ASSERT_EQUAL_HEX8(0x02, bytes[1]);
    TEST_ASSERT_EQUAL_HEX8(0x03, bytes[2]);
    TEST_ASSERT_EQUAL_HEX8(0x04, bytes[3]);
    TEST_ASSERT_EQUAL_HEX8(0x05, bytes[4]);
    TEST_ASSERT_EQUAL_HEX8(0x06, bytes[5]);
    TEST_ASSERT_EQUAL_HEX8(0x07, bytes[6]);
    TEST_ASSERT_EQUAL_HEX8(0x08, bytes[7]);
}
