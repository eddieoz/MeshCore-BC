...
// Subclass Tests
#include "bitchat/test_bitchat_mesh.cpp"
...
int main(int argc, char **argv) {
  ...
  // BitchatMesh Tests
  RUN_TEST(test::bitchat::test_bitchat_mesh_instantiates);
  RUN_TEST(test::bitchat::test_bitchat_mesh_fallback_to_base_chat);
  RUN_TEST(test::bitchat::test_bitchat_mesh_intercepts);
  RUN_TEST(test::bitchat::test_bitchat_mesh_subclass_delegation_pattern);
  UNITY_END();
