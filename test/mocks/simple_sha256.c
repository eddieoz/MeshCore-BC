/**
 * Simple SHA256 implementation for native tests
 * Minimal implementation to avoid OpenSSL dependency
 */
...
// External interface
void simple_sha256(const uint8_t* data, size_t len, uint8_t hash[32]) {
    sha256_ctx ctx;
    sha256_init(&ctx);
